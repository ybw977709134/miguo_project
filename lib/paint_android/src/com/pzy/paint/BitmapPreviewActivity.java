...
public class BitmapPreviewActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        surfaceView = (DoodleSurfaceView) findViewById(R.id.surfaceView_show);
...
//        q.find(R.id.linearLayout_cancel).clicked(this);
    ...
    protected int getLayoutResId() {
        return R.layout.bitmap_preview;
    }
