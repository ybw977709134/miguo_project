 ...
 * Bulletin
 */
public class Bulletins implements Parcelable, IHasMultimedia, IHasReview {
...
//    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(bulletinId);
        dest.writeString(uid);
        dest.writeString(momentId);
    ...
    public static Creator<Bulletins> CREATOR = new Creator<Bulletins>() {
        @Override
        public Bulletins createFromParcel(Parcel s) {
            Bulletins m = new Bulletins();
            m.allowReview = 1 == s.readInt();
            m.bulletinId = s.readInt();
            m.uid = s.readString();
            m.momentId = s.readString();
