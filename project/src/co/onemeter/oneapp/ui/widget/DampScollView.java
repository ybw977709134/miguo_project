...
/**
 * This is DampScollView Used for Pulling Down ScollView to Enlarge ImageView
 * Create By Jacky on 1/28/2015
 */
public class DampScollView extends ScrollView {
	...
	public DampScollView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

	}

	public DampScollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mScroller = new Scroller(context);
	}

	public DampScollView(Context context) {
		super(context);
